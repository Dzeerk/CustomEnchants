...
public class LastStandI implements Listener {
	...
	if(p.getInventory().getLeggings().getType() == Material.LEATHER_LEGGINGS && p.getInventory().getLeggings().getItemMeta().getLore().contains("§9Last Stand I") && p.getHealth() <= 14){
